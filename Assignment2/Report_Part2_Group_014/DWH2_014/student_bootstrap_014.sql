...
-- Please do not work/connect under the default 'postgres' role, create your own grp_014 role (014 is your group number)
...
-- -------------------------------
-- 2. Create the "student group" role (replace 014 with your three-digit group number). You can choose your own password for your role or just use this simple '123' password.
-- -------------------------------
DROP ROLE IF EXISTS grp_014;
CREATE ROLE grp_014 LOGIN PASSWORD '123';
GRANT CONNECT, CREATE ON DATABASE airq TO grp_014;
